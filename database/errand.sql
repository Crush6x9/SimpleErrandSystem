...
CREATE TABLE `order`  (
  ...
  `status` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '订单状态（0 待帮助，1 已接单，2 已完成）',
...
CREATE TABLE `wallet`  (
  ...
  `balance` decimal(6, 2) NULL DEFAULT 0.00 COMMENT '可提现余额',
