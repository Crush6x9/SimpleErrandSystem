      ...
      <van-dialog v-model:show="showVerificationDialogVisible" title="输入验证码" :show-confirm-button="false"
        ...
        <div class="verification-content">
          ...
          <div class="code-input-container">
            <input v-for="(code, index) in verificationCodeArray" :key="index" type="tel" maxlength="1"
              class="code-input" @input="handleCodeInput(index, $event)" @keydown="handleCodeKeyDown(index, $event)"
              ref="codeInputs">
          </div>
