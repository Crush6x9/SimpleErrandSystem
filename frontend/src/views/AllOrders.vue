      ...
      <div class="content">
        <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
          <van-list v-model:loading="loading" :finished="finished" finished-text="—— 没有更多了 ——" @load="onLoad">
            <div v-for="order in displayOrders" :key="order.id" class="order-card" @click="toDetail(order.id)">
              <div class="top">
...
const loadOrders = () => {
  ...
  if (savedOrders) {
    ...
    // 如果没有保存的订单，使用模拟数据
    const initialOrders = [
      { id: 101, title: '帮买瑞幸咖啡+面包', address: '瑞幸(校门口)', price: 28.5, status: 0, createTime: '2025-11-08 11:30', publisherName: '王小二', hasRated: false },
      { id: 102, title: '取韵达快递', address: '快递柜', price: 10, status: 1, createTime: '2025-11-08 10:15', publisherName: '赵六', accepter: currentUser, hasRated: false },
      { id: 103, title: '送文件到教务处', address: 'A座3楼', price: 15, status: 1, createTime: '2025-11-08 09:40', publisherName: currentUser, accepter: '李四', hasRated: false },
      { id: 104, title: '占座图书馆3楼', address: '图书馆', price: 25, status: 0, createTime: '2025-11-08 08:20', publisherName: '孙八', hasRated: false },
      { id: 105, title: '帮打饭', address: '二餐', price: 12, status: 2, createTime: '2025-11-08 12:00', publisherName: currentUser, accepter: '王五', hasRated: false }
    ]
